...
- Owner outside the configured allowlist unless the operator named this job. **Partial:** watchlist `check-all` reads `WRIT_ALLOWED_OWNERS`; other scheduling is still operator-upheld (#146).
